 ...
 * @author Dave Syer
 */
public class MyOAuth2RestTemplate extends RestTemplate implements OAuth2RestOperations {
    ...
    public OAuth2AccessToken getAccessToken() throws UserRedirectRequiredException {
        ...
        // Request existing acces token for context
        OAuth2AccessToken accessToken = context.getAccessToken();


        logger.info("Got accessToken: " + accessToken);

        // if token is null or expired - re request the token
    ...
    protected OAuth2AccessToken acquireAccessToken(OAuth2ClientContext oauth2Context)
        ...
        logger.info("Acquired Access Token: " + accessToken);
        return accessToken;
    }
